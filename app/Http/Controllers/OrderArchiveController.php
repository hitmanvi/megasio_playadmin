...
{
    /**
     * Get order archives list with filtering and pagination
     */
    public function index(Request $request): JsonResponse
    {
        ...
        $query = OrderArchive::with(['game', 'brand', 'user']);
        ...
        $orderArchives = $query->paginate($perPage);

        return $this->responseListWithPaginator($orderArchives, null);
    }
}
